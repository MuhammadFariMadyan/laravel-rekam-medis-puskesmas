...
class ResepController extends Controller
{
  ...
  public function showTambahResep()
  {
    ...
    return view('dokter.dashboard.resep.tambahresep')
  ...
  { 
    ...
    return view('dokter.dashboard.resep.resep',$data);
  }    
  ...
  public function hapus($no_resep)
  {
    ...
    return Redirect::action('Dokter\ResepController@index');
 ...
 public function editresep($no_resep)
    {
        ...
        return view('dokter.dashboard.resep.editresep',$data)
 ...
 public function simpanedit($no_resep)
    ...
    protected function Cetak($no_resep, $kdPrint){  
      ...
      $pdf = PDF::loadView('dokter.dashboard.resep.cetakresep',$data);      
      if($kdPrint==1)
