...
class PasienController extends Controller
{
  ...
  public function showTambahPasien()
  {
    ...
    return view('admin.dashboard.pasien.tambahpasien');
  } 
  ...
  public function index()
  {
    ...
    return view('admin.dashboard.pasien.pasien',$data);
  }    
  ...
  public function hapus($kode_pasien)
  {
    ...
    Session::flash('flash_message', 'Data Rekam Medis "'.$kode_pasien->kode_pasien.'" - "'.$kode_pasien->nama_pasien.'" Berhasil dihapus.');

    return Redirect::action('Admin\PasienController@index');
 ...
 public function editpasien($kode_pasien)
    {
        ...
        return view('admin.dashboard.pasien.editpasien',$data)
