...
class DokterController extends Controller
{
  ...
  {
    return view('admin.dashboard.dokter.tambahdokter');
  }
  ...
  public function index()
  {
    ...
    return view('admin.dashboard.dokter.dokter',$data);
  }    
  ...
  public function hapus($kode_dktr)
  {
    ...
    return Redirect::action('Admin\DokterController@index');
 ...
 public function editdokter($kode_dktr)
    {
        ...
        return view('admin.dashboard.dokter.editdokter',$data)
