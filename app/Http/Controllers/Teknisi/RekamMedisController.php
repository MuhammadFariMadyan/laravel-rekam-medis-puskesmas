...
class RekamMedisController extends Controller
{
  ...
  public function indexLapRedis()
  {
    ...
    return view('teknisi.dashboard.rekammedis.laporan_rekammedis',$data);
  } 
  ...
  public function showTambahRekamMedis()
  {
    ...
    $dataPasien= Pasien::select(DB::raw("kode_pasien"))
        ...
        ->get();
    return view('teknisi.dashboard.rekammedis.tambahrekammedis')
  ...
  public function index()
  {
    ...
    $data = array('rekammedis' => $dataRekamMedis);   
    return view('teknisi.dashboard.rekammedis.rekammedis',$data);
  }    
  ...
  public function hapus($no_redis)
  {
    ...
    return Redirect::action('Teknisi\RekamMedisController@index');
 ...
 public function editrekammedis($no_redis)
    {
        ...
        return view('teknisi.dashboard.rekammedis.editrekammedis',$data)
 ...
 public function simpanedit($no_redis)
    ...
    protected function Cetak($no_redis, $kdPrint){  
      ...
      $pdf = PDF::loadView('teknisi.dashboard.rekammedis.cetakrekammedis',$data);      
      if($kdPrint==1)
  ...
  protected function CetakDateRange(Request $request, $kdPrint){
      ...
      $pdf = PDF::loadView('teknisi.dashboard.rekammedis.cetaklaporanrekammedis', $data); 
      if($kdPrint==1)
        return $pdf->download('Laporan Rekam Medis.pdf');            
      else
        return $pdf->stream('Laporan Rekam Medis.pdf');    
