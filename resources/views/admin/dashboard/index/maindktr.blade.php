...
@section('breadcrump')
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Dashboard Dokter</li>
          </ol>
@stop
@section('content')
    ...
    <div class="box">
            ...
            <div style="display: block;" class="box-body">
                <ul>                
                <li>
                1. Data Rekam Medis -> digunakan untuk...</li>                
                <li>                
                2. Data Resep -> digunakan untuk...</li>
                <li>
                3. Data  Rujuk -> digunakan untuk...</li>

            </div><!-- /.box-body -->
            <div style="display: block;" class="box-footer">
              nb : dokter email => dokter@gmail.com
            </div><!-- /.box-footer-->
          </div>
