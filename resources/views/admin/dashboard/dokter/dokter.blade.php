            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tambah Dokter <a href="{{{ URL::to('admin/tambahdokter') }}}" class="btn btn-success btn-flat btn-sm" id="tambahDokter" title="Tambah"><i class="fa fa-plus"></i></a></h3>
                </div><!-- /.box-header -->
                    ...
                    <tbody>
                     <?php foreach ($dokter as $dataDokter):  ?>
                      <tr>
                        ...
                        <td><a href="{{{ URL::to('admin/dokter/'.$dataDokter->kode_dktr.'/edit') }}}">
                              <span class="label label-warning" ><i class="fa fa-edit" >&nbsp;&nbsp; Edit &nbsp;&nbsp;</i></span>
                              </a> 
                          <a href="{{{ action('Admin\DokterController@hapus',[$dataDokter->kode_dktr]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Dokter {{{($dataDokter->kode_dktr).' - '.$dataDokter->nama_dktr }}}?')">
