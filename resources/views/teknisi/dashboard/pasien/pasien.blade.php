            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tambah Data Pasien <a href="{{{ URL::to('teknisi/tambahpasien') }}}" class="btn btn-success btn-flat btn-sm" id="tambahPasien" title="Tambah"><i class="fa fa-plus"></i></a></h3>
                </div><!-- /.box-header  -->
                    ...
                    <tbody>
                     <?php foreach ($pasien as $dataPasien):  ?>
                      <tr>
                        ...
                        <td><a href="{{{ URL::to('teknisi/pasien/'.$dataPasien->kode_pasien.'/edit') }}}">
                              <span class="label label-warning" ><i class="fa fa-edit" >&nbsp;&nbsp; Edit &nbsp;&nbsp;&nbsp;</i></span>
                              </a> 
                          <a href="{{{ action('Teknisi\PasienController@hapus',[$dataPasien->kode_pasien]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Pasien {{{($dataPasien->kode_pasien).' - '.$dataPasien->nama_pasien }}}?')">
                              <span class="label label-danger"><i class="fa fa-trash">&nbsp;&nbsp; Delete &nbsp;&nbsp;</i></span>
                              </a> 
                          <a href="{{{ URL::to('teknisi/pasien/'.$dataPasien->kode_pasien.'/cetak/233') }}}"><span class="label label-info"><i class="fa fa-print">&nbsp;&nbsp;Cetak&nbsp;&nbsp;</i></span> 
                              </a>                         
                          </td>                              
                      </tr>
                      <?php endforeach  ?> 
