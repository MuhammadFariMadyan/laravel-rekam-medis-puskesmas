            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      ...
                      <form id="formRekamMedisTambah" class="form-horizontal" role="form" method="POST" action="{{ url('teknisi/rekammedis/tambah') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="{{{ action('Teknisi\RekamMedisController@index') }}}" title="Cancel">
