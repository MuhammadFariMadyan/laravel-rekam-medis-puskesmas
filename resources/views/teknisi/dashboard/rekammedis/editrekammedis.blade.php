            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body no-padding">
                      ...
                      <form id="formRekamMedisEdit" class="form-horizontal" role="form" method="POST" action="{{ url('teknisi/rekammedis/'.$no_redis.'/simpanedit') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="{{{ action('Teknisi\PasienController@index') }}}" title="Cancel">
