            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                  <div class="box-header">
                    <h3 class="box-title">Data Resep - Edit</h3>
                  </div><!-- /.box-header -->
                  <div class="box-body no-padding">

                      <form id="formResepEdit" class="form-horizontal" role="form" method="POST" action="{{ url('teknisi/resep/'.$no_resep.'/simpanedit') }}">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" class="form-control" name="no_resep" value="{{$no_resep}}" disabled="true">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                              <input type="text" class="form-control" name="resep" value="{{$resep}}">
                              <small class="help-block"></small>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-6">
                            {!! Form::date('tgl_resep', $tgl_resep, ['class' => 'form-control', 'placeholder' => 'Masukkan Tanggal Lahir']) !!}                              
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-md-6 col-md-offset-4">
                              ...
                              <a href="{{{ action('Teknisi\ResepController@index') }}}" title="Cancel">
