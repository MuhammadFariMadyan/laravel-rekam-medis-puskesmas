            ...
            <div class="col-xs-12">
              <div class="box">                
                <div class="box-header" >
                  <h3 class="box-title">Tambah Data Rekam Medis <a href="{{{ URL::to('dokter/tambahrekammedis') }}}" class="btn btn-success btn-flat btn-sm" id="tambahRekamMedis" title="Tambah"><i class="fa fa-plus"></i></a>                    
                  </h3>                                                                         
                </div><!-- /.box-header -->                 
                <div class="box-body">
                    ...
                    <tbody>
                     <?php foreach ($rekammedis as $dataRekamMedis):  ?>
                      <tr>
                        ...
                        <td><a href="{{{ URL::to('dokter/rekammedis/'.$dataRekamMedis->no_redis.'/edit') }}}">
                              <span class="label label-warning" ><i class="fa fa-edit" >&nbsp;&nbsp; Edit &nbsp;&nbsp;</i></span>
                              </a> 
                            <a href="{{{ action('Dokter\RekamMedisController@hapus',[$dataRekamMedis->no_redis]) }}}" title="hapus"   onclick="return confirm('Apakah anda yakin akan menghapus Data Rekam Medis {{{($dataRekamMedis->no_redis).' - '.$dataRekamMedis->kode_pasien }}}?')">
                              <span class="label label-danger"><i class="fa fa-trash">&nbsp;&nbsp; Delete &nbsp;&nbsp;</i></span>
                               <a href="{{{ URL::to('dokter/rekammedis/'.$dataRekamMedis->no_redis.'/cetak/233') }}}">
